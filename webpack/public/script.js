...
// EXTERNAL MODULE: ./node_modules/mini-css-extract-plugin/dist/loader.js??ruleSet[1].rules[3].use[1]!./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/scss/style.scss
...
var update = injectStylesIntoStyleTag_default()((style_default()), options);
       ...
       /* harmony default export */ const scss_style = ((style_default()) && (style_default()).locals ? (style_default()).locals : undefined);

;// CONCATENATED MODULE: ./src/js/menu.json
...
/* harmony default export */ const js_localStorage = ({
...
var setClassesLight = function setClassesLight(body, LIGHT, DARK) {
  window.localStorage.setItem("theme", JSON.stringify(LIGHT));
  body.classList.add(LIGHT);
  body.classList.remove(DARK);
};
var setClassesDark = function setClassesDark(body, LIGHT, DARK) {
...
/* harmony default export */ const js_refs = (refs);
...
var body = js_refs.body,
    themeSwitchToggle = js_refs.themeSwitchToggle,
    jsMenu = js_refs.jsMenu;
var LIGHT = theme.LIGHT,
    DARK = theme.DARK;
var savedTheme = js_localStorage.savedTheme;
var markup = menu_handlebars_default()(menu_namespaceObject);
js_refs.jsMenu.innerHTML = markup;

var swtitchToggle = function swtitchToggle() {
  themeSwitchToggle.checked ? setClassesDark(body, LIGHT, DARK) : setClassesLight(body, LIGHT, DARK);
};

var memorizeTheme = function memorizeTheme() {
  savedTheme === DARK ? (themeSwitchToggle.checked = true, setClassesDark(body, LIGHT, DARK)) : window.localStorage.setItem("theme", JSON.stringify(LIGHT));
};
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "  <li class=\"menu__item\">\r\n    <article class=\"card\">\r\n      <img src="
    ...
    + "\r\n        </p>\r\n        <ul class=\"tag-list\">\r\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"ingredients") : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":16,"column":12},"end":{"line":18,"column":21}}})) != null ? stack1 : "")
